/**
 * Ramos Elegantes Image Manager - Refactorizado
 * Extiende BaseImageManager eliminando duplicación de código
 */
class RamosElegantesImageManager extends BaseImageManager {
    constructor() {
    ...
    /**
     * Inicialización específica para ramos elegantes
     */
    init() {
        this.imageDatabase = {
            'ramos-elegantes': [
    ...
    /**
     * Configuración específica para ramos elegantes
     */
    getConfig() {
